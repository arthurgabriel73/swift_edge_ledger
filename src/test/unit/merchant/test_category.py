...
class TestCategory:
    def test_use_constructor_outside_class(self):
        ...
        with pytest.raises(RuntimeError, match='Use the create method to instantiate a Category'):
            Category(category_id=123, name="FOOD", description="A food category", created_at=get_utc_now())
    ...
    def test_use_create_method(self):
        ...
        # Act
        category = Category.create(category_id, name, description)
    ...
    def test_use_from_value_method(self):
        ...
        # Act
        category = Category.from_value(category_id=category_id, name=name, description=description, created_at=created_at)
