...
class Activity:
    ...
    def __init__(self, activity_id: ActivityId, timestamp: datetime.timestamp, account_id: UUID, amount_in_cents: int, category_id: int, merchant_id: UUID, status_id: int):
    ...
    @classmethod
    def create(cls, activity_id: ActivityId, account_id: UUID, amount_in_cents: int, category_id: int, merchant_id: UUID, status_id: int) -> 'Activity':
        cls.__allow_instantiation = True
        return cls(activity_id, get_utc_now().timestamp(), account_id, amount_in_cents, category_id, merchant_id, status_id)
